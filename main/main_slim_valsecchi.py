...
slim_gsgp_solve_parameters = {"elitism": True,
                              ...
                              "verbose": 1,
                              "test_elite": True,
                              "log_path": os.path.join(os.getcwd(), "log", f"slim_valsecchi_{day}.csv"),
                              "run_info": None,
...
for algo_name in algos:
    ...
    for (sig, ttress, op, gsgp) in [
        ...
        for seed in range(1):
            ...
            slim_GSGP_parameters["ms"] = generate_random_uniform(0, 10 )
            ...
            if slim_gsgp_solve_parameters['log'] > 0:
                with open(os.path.join(os.getcwd(), "log", f"elite_looks_valsecchi_{day}.csv"), 'a', newline='') as file:
