...
from evaluators.fitness_functions import rmse, inverse_r2
...
slim_gsgp_solve_parameters = {"elitism": True,
                              ...
                              "verbose": 1,
                              "test_elite": True,
                              "log_path": os.path.join(os.getcwd(), "log", f"correlation_{day}.csv"),
                              "run_info": None,
                              "ffunction": None,
                              "n_iter": 1000,
                              "max_depth": None,
...
slim_GSGP_parameters = {"initializer": rhh,
                        ...
                        # "deflate_mutator": weighted_deflate_mutation,
                        "p_xo": 0,
                        "pop_size": 100,
    ...
    for loader in data_loaders:
        ...
        for algo_name in algos:
            ...
            for (sig, ttress, op, gsgp) in [(True, True, "sum", True), (True, False, "mul", False), (False, False, "mul", False), (True, True, "sum", False)]: # (True, True, "sum"), (True, True, 'std')
                ...
                slim_GSGP_parameters["deflate_mutator"] = deflate_mutation
                ...
                for seed in range(30):
                    ...
                    slim_gsgp_solve_parameters['run_info'] = [algo, metric.__name__, dataset]
                    slim_gsgp_solve_parameters["ffunction"] = metric
