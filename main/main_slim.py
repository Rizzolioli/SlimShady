...
data_loaders = [ load_concrete_strength, load_istanbul, load_bioav, load_boston]
...
slim_gsgp_solve_parameters = {"elitism": True,
                              ...
                              "verbose": 1,
                              "test_elite": True,
                              "log_path": os.path.join(os.getcwd(), "log", f"islim_{day}.csv"),
                              "run_info": None,
                              "ffunction": rmse,
                              "n_iter": 1000,
                              "max_depth": None,
        ...
        (True, False, "sum", False),  # SLIM+1SIG
            ...
            for selector in []:
                ...
                for seed in range(30):
                    ...
                    slim_GSGP_parameters["inflate_mutator"] = inflate_mutation(FUNCTIONS=FUNCTIONS,
                                                                              TERMINALS=TERMINALS,
                                                                              CONSTANTS=CONSTANTS,
