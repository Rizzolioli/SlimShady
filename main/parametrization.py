...
gp_solve_parameters = {"elitism": True,
                    ...
                    "verbose": 1,
                    "test_elite": True,
                    "log_path": os.path.join(os.getcwd(), "log", "LR_gp.csv"),
                    "run_info": None,
                    "max_depth": 17,
                    "max_": False,
                    "ffunction": rmse,
...
gsgp_solve_parameters = {"elitism": True,
                    ...
                    "verbose": 1,
                    "test_elite": True,
                    "log_path": os.path.join(os.getcwd(), "log", "LR_gsgp.csv"),
                    "run_info": None,
                    "max_": False,
                    "ffunction": rmse,
                    "n_iter": 2000,
...
slim_gsgp_solve_parameters = {"elitism": True,
                    ...
                    "verbose": 1,
                    "test_elite": True,
                    "log_path": os.path.join(os.getcwd(), "log", "LR_slim.csv"),
                    "run_info": None,
                    "max_": False,
                    "ffunction": rmse,
                    "n_iter": 2000,
...
slim_dataset_params = {"toxicity": {"p_inflate": 0.1, "ms": generate_random_uniform(0, 1)},
