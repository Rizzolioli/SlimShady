...
from evaluators.fitness_functions import rmse, sign, sign_rmse
            ...
            for extra_noise in [0, 1, 5, 10, 50]:
                ...
                for algo_name in algos:
                    ...
                    for (sig, ttress, op, gsgp) in [(True, False, "mul", False), (False, False, "mul", False), (True, True, "sum", False)]: # (True, True, "sum"), (True, True, 'std')
                        ...
                        slim_GSGP_parameters["deflate_mutator"] = weighted_deflate_mutation(metric, np.random.choice)
                        ...
                        for seed in range(30):
                            ...
                            slim_gsgp_solve_parameters['run_info'] = [algo, noise_creation.__name__,
                                                                      extra_noise, metric.__name__, dataset]
