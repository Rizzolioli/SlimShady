...
slim_gsgp_solve_parameters = {"elitism": True,
                              ...
                              "verbose": 1,
                              "test_elite": True,
                              "log_path": os.path.join(os.getcwd(), "log", "missing_values_baseline.csv"),
                              "run_info": None,
                              "ffunction": rmse,
                              "n_iter": 1000,
                              "max_depth": None,
            ...
            for algo_name in algos:
                ...
                for (sig, ttress, op) in [(True, False, "mul"), (False, False, "mul"), (True, True, "sum")]:
                    ...
                    for seed in range(n_runs):
                        ...
                        setattr(imputers[imputer], 'random_state', seed)
                        ...
                        X_train = torch.from_numpy(imputers[imputer].fit_transform(X_train))
                        X_test = torch.from_numpy(imputers[imputer].transform(X_test))
