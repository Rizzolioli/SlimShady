...
# load_yatch,
data_loaders = [ load_airfoil, load_concrete_slump, load_concrete_strength, load_ppb,
...
slim_gsgp_solve_parameters = {"elitism": True,
                              ...
                              "verbose": 1,
                              "test_elite": True,
                              "log_path": os.path.join(os.getcwd(), "log", "elite_change.csv"),
                              "run_info": None,
                              "ffunction": rmse,
                              "n_iter": 1000,
                              "max_depth": None,
...
for loader in data_loaders:
    ...
    for algo_name in algos:
        ...
        for (sig, ttress, op) in [ (True, True, "sum"), (True, False, "mul"), (False, False, "mul")]: #
            ...
            for pause_deflate in [100, 250, 500, 750, 900, 1000]:
                ...
                for seed in ranger:
                    ...
                    slim_gsgp_solve_parameters['pause_deflate'] = pause_deflate

                    # adding the dataset name and algorithm name to the run info for the logger
                    slim_gsgp_solve_parameters['run_info'] = [algo, unique_run_id,  pause_deflate,  dataset]
