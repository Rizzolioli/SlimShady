...
_LOG_PATH      = os.path.join(os.path.dirname(__file__), "log", "results_head_size_07052026.csv")
_SETTINGS_PATH = os.path.join(os.path.dirname(__file__), "log", "settings_head_size.csv")
